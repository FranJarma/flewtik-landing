        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="mb-4 flex items-center space-x-3">
              <div className="bg-primary glow-purple flex size-8 items-center justify-center rounded-lg">
            ...
            <div className="flex space-x-4">
              <Link
                href="#"
                className="hover:bg-primary flex size-10 items-center justify-center rounded-lg bg-zinc-800 transition-colors duration-300"
              >
          ...
          <div className="flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <div className="flex items-center">
                <MapPin className="text-secondary mr-1 size-4" />
                Salta Capital, Argentina
              </div>
              <div className="flex items-center">
                <Mail className="text-primary mr-1 size-4" />
                hola@flewtik.com.ar
              </div>
            </div>
