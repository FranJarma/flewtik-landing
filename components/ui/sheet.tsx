    ...
    <SheetPortal>
      ...
      >
        <div className="flex justify-end border-b border-zinc-800 p-4">
          <SheetPrimitive.Close className="mt-3 mr-3 cursor-pointer rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden">
