  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="bg-flewtik-secondary/10 absolute right-1/4 bottom-1/4 size-96 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 pt-40 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            <span className="bg-flewtik-secondary mr-2 size-2 animate-pulse rounded-full" />
          ...
          >
            Automatizá tu negocio. <span className="text-flewtik-primary">Escalá</span> sin
            fricción.
          </motion.h1>
          ...
          >
            <Button
              size="lg"
              className="bg-flewtik-primary hover:bg-flewtik-primary/90 animate-glow hover-lift px-8 py-4 text-lg font-semibold text-white"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="hover:text-flewtik-primary hover-lift border-zinc-700 bg-transparent px-8 py-4 text-lg text-white hover:bg-zinc-900"
            >
          ...
          >
            <div className="text-center">
              <div className="text-flewtik-primary mb-2 text-3xl font-bold">50+</div>
              <div className="text-gray-400">Empresas automatizadas</div>
            </div>
            <div className="text-center">
              <div className="text-flewtik-secondary mb-2 text-3xl font-bold">80%</div>
              <div className="text-gray-400">Reducción en tiempo</div>
            </div>
            <div className="text-center">
              <div className="text-flewtik-primary mb-2 text-3xl font-bold">24/7</div>
