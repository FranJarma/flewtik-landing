      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
            Resultados que <span className="text-flewtik-primary">hablan</span>
          </h2>
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="glass hover-lift rounded-2xl p-8">
                {/* Icon */}
                <div className="group-hover:bg-flewtik-primary/20 mx-auto mb-6 flex size-16 items-center justify-center rounded-2xl bg-zinc-900 transition-colors duration-300">
                  <stat.icon className="text-flewtik-primary size-8" />
                </div>
