      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="mb-6 text-4xl font-bold lg:text-5xl">
            Cómo <span className="text-flewtik-primary">funciona</span>
          </h2>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="glass hover-lift h-full rounded-2xl p-8">
                {/* Step number */}
                <div className="bg-flewtik-primary glow-purple absolute -top-4 -left-4 flex size-8 items-center justify-center rounded-full text-sm font-bold text-white">
                  {index + 1}
                </div>

                {/* Icon */}
                <div className="group-hover:bg-flewtik-primary/20 mb-6 flex size-16 items-center justify-center rounded-2xl bg-zinc-900 transition-colors duration-300">
                  <step.icon className="text-flewtik-primary size-8" />
                </div>
